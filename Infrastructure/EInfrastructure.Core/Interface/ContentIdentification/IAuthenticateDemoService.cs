...
namespace EInfrastructure.Core.Interface.ContentIdentification
{
    ...
    public interface IAuthenticateDemoService
    {
        ...
        /// <returns></returns>
        ContentInfoDto ImgAuthenticateByUrl(string url, WebProxy webProxy = null);
        ...
        /// <param name="webProxy">代理信息</param>
        /// <returns></returns>
        ContentInfoDto ImgAuthenticateByBase64(string base64, WebProxy webProxy = null);
        ...
        /// <param name="webProxy">代理信息</param>
        /// <returns></returns>
        ContentInfoDto ImgAuthenticateByFile(IFormFile formFile, WebProxy webProxy = null);
    }
}