...
using EInfrastructure.Core.QiNiu.Storage.Tools.Validator;
using EInfrastructure.Core.Validation.Common;
using Qiniu.Storage;
using Qiniu.Util;
using ChunkUnit = EInfrastructure.Core.Config.StorageExtensions.Enumerations.ChunkUnit;

namespace EInfrastructure.Core.QiNiu.Storage.Tools
{
    /// <summary>
    /// 基类存储实现类
    /// </summary>
    public class BaseStorageProvider
    {
        ...
        ///
        /// </summary>
        protected BaseStorageProvider(QiNiuStorageConfig qiNiuConfig)
        {
        ...
        /// </summary>
        /// <returns></returns>
        protected Qiniu.Storage.Config GetConfig(UploadPersistentOps uploadPersistentOps = null)
        {
