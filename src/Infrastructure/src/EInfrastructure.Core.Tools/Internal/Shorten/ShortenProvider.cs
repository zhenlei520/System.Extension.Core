...
namespace EInfrastructure.Core.Tools.Internal.Shorten
{
    /// <summary>
    ///
    /// </summary>
    public class ShortenProvider : IdentifyDefault, IShortenProvider
    {
        /// <summary>
        ///
        /// </summary>
        ...
        public string[] GetShortParam(string param, string key, int number = 6)
        {
