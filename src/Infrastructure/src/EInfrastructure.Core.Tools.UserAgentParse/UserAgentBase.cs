            ...
            CheckUserAgent(userAgent, "Linux", (mc) =>
            {
                ...
                CheckUserAgent(userAgent, "CentOS", (mc2) =>
                {
                    ...
                    CheckUserAgent(userAgent, @"CentOS\/[0-9\.\-]+el([0-9_]+)",
                        (mc3) => { Os.Version = new Versions(GetVersionResult(mc3,RegexDefault.FloatingPointNumbers).ReplaceRegex("_", "")); });
                });
                    ...
                    userAgent.Test(@"iPhone\s*\d*s?[cp]?;", RegexOptions.IgnoreCase))
                {
                    ...
                    CheckUserAgent(userAgent, "OS (.*) like Mac OS X",
                        ...
                        {
                            Os.Version =
                                new Versions(GetVersionResult(mc3,RegexDefault.FloatingPointNumbers).ReplaceRegex("_", RegexOptions.Compiled, "."));
                        });
                ...
                */
                ...
                if (CheckUserAgent(userAgent, "Iris"))
                {
                    ...
                    {
                        Os.Version = new Versions(GetVersionResult(mc3,RegexDefault.FloatingPointNumbers) + ".0");
                    }
                    else
                    {
